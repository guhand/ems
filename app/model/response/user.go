...
type FetchUserByID struct {
	...
	DeparmentMemberID *uint   `json:"departmentMemberID" gorm:"column:departmentMemberID"`
}
...
type FetchUnmappedLeadUsers struct {
	ID   uint   `json:"id"`
	Name string `json:"name" gorm:"column:name"`
}

type FetchUnmappedEmployeeUsers struct {
	ID   uint   `json:"id"`
	Name string `json:"name" gorm:"column:name"`
}
