...
func (h *PermissionHandler) FetchPermissions(c *gin.Context) {
	...
	data, err := h.permissionService.FetchPermissions(*user.DepartmentMemberID, &filters)
	...
	api_response.Success(c, "Permissions fetched successfully", data)
}
...
func (h *PermissionHandler) FetchUserPermissions(c *gin.Context) {
	...
	data, err := h.permissionService.FetchUserPermissions(*user.DepartmentID, &filters)
	...
	api_response.Success(c, "User Permissions leaves fetched successfully", data)
}
...
func (h *PermissionHandler) UpdatePermissionStatus(c *gin.Context) {
	...
	api_response.Success(c, "Permission status updated successfully", nil)
}
...
func (h *PermissionHandler) UpdatePermissionRequest(c *gin.Context) {
	...
	if err := h.permissionService.UpdatePermissionRequest(uint(id), &req); err != nil {
		api_response.InternalServerError(c, err.Error())
		return
	}
