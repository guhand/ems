...
func (h *UserHandler) FetchUserStatus(c *gin.Context) {
	data, err := h.userService.FetchUserStatus()
	...
	api_response.Success(c, "User status fetched successfully", data)
}
...
func (h *UserHandler) FetchUserDetails(c *gin.Context) {
	...
	api_response.Success(c, "User KYC fetched successfully", data)
}
...
func (h *UserHandler) FetchFilePathsByUserID(c *gin.Context) {
	...
	api_response.Success(c, "Uploaded documents fetched successfully", data)
}
